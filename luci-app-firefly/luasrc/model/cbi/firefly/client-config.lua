...
m = Map(firefly, translate("Edit firefly Server"))
m.redirect = luci.dispatcher.build_url("admin/vpn/firefly/servers")
if m.uci:get(firefly, sid) ~= "servers" then
