...
m = Map(firefly, translate("SS/SSR/V2RAY Server"))
m:section(SimpleSection).template  = "firefly/status3"
local type = {
	"ssr",
	"ss",
	"v2ray",
...
sec.extedit = luci.dispatcher.build_url("admin/vpn/firefly/server/%s")
function sec.create(...)
...
o.width="10%"
m:append(Template("firefly/server_list"))
return m
